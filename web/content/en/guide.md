...
Complete **[Install & config](./lab.html?id=00-install-config)** before continuing. Use **local** config in the lab playground so your global Git settings stay untouched.
...
Complete **[First repo](./lab.html?id=01-first-repo)** before continuing.
...
Practice isolation first: **[Branching](./lab.html?id=00-branching)**.  
Then merge in the next chapter’s lab: **[Branch & merge](./lab.html?id=02-branch-merge)**.
...
Same practice as branching: **[Branch & merge](./lab.html?id=02-branch-merge)**
...
Practice the commands offline first: **[Local remote](./lab.html?id=00-local-remote)**.  
Then use a real GitHub repo: **[Remote & PR](./lab.html?id=06-remote-pr)** (needs a GitHub account).
...
Finish the remote practice: **[Remote & PR](./lab.html?id=06-remote-pr)**
...
**[Lab 08 — Stash](./lab.html?id=08-stash)**
...
**[Lab 09 — Tags](./lab.html?id=09-tags)**
...
**[Lab 14 — Worktrees](./lab.html?id=14-worktrees)**
...
**[Lab 15 — Inspect history](./lab.html?id=15-inspect-history)**
...
**[Lab 16 — Hooks](./lab.html?id=16-hooks)**
...
**[Lab 17 — Signing commits](./lab.html?id=17-signing)**
...
**[Lab 18 — Forks & remotes](./lab.html?id=18-forks)**
...
**[Lab 19 — Submodules & LFS](./lab.html?id=19-submodules-lfs)**
...
- [ ] Create branches for features and bug fixes ([Branching](./lab.html?id=00-branching))
- [ ] Merge finished work into `main` ([Branch & merge](./lab.html?id=02-branch-merge))
- [ ] Resolve one conflict on purpose ([Conflict](./lab.html?id=03-conflict))
...
- [ ] Push, fetch, and pull against a remote ([Local remote](./lab.html?id=00-local-remote))
- [ ] Push a branch and open a PR ([Remote & PR](./lab.html?id=06-remote-pr))
