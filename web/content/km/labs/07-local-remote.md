# មន្ទីរពិសោធន៍ 07 — Remote ក្នុងស្រុក

## គោលដៅ

អនុវត្ត `remote`, `push`, `fetch` និង `pull` ដោយប្រើ **bare repo ក្នុងស្រុក** ជា `origin` — មិនត្រូវការគណនី GitHub។ មន្ទីរពិសោធន៍ 08 បន្ថែម PR ពិតនៅលើ GitHub បន្ទាប់មក។
