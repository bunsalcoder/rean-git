...
លំហាត់នេះប្រើ Git config **ក្នុងស្រុក** ដូច្នេះមិនផ្លាស់ប្តូរការចុះហត្ថលេខា global របស់អ្នក។ នៅលើម៉ាស៊ីនពិត អ្នកនឹងប្រើ `--global` ហើយបន្ថែម public key ដូចគ្នាជា signing key នៅលើ GitHub។
